        ...
        <div className="min-h-screen bg-white text-slate-900 font-sans py-20">
            <div className="max-w-3xl mx-auto px-6">
                ...
                <div className="space-y-10 text-slate-600 leading-relaxed font-medium">
                    ...
                    <p className="text-sm">
                        株式会社nots（以下「当社」といいます。）は、プラットフォームサービス「INSIDERS」（以下「本サービス」といいます。）の提供において、ユーザー（広告主およびクリエイターを含みます。）の個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」といいます。）を定めます。
                    </p>
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-5 mt-2 space-y-1">
                            ...
                            <li>広告主とクリエイター間のマッチング、取引の円滑な進行、および代金決済（代理受領・送金）のため</li>
                            <li>ユーザーの本人確認および不正利用の防止のため</li>
                            <li>本サービスのシステム改善、新機能の開発、およびAI（人工知能）技術を用いたマッチングアルゴリズムの学習・精度向上のため</li>
                            <li>メンテナンス、重要なお知らせなど必要に応じたご連絡のため</li>
                        </ul>
                    </section>

                    <section>
                        <h2 className="text-xl font-black text-slate-900 mb-4">3. 第三者への情報提供および共有</h2>
                        <p>
                        ...
                        <p>
                            2. 前項の定めに拘わらず、本サービスの目的である「広告主とクリエイター（海外在住の者を含みます）とのマッチング」を円滑に遂行するため、ユーザーは、プロフィール情報、店舗情報、取引条件等の必要最小限の情報が、本サービス上において取引の相手方に共有されることに予め同意するものとします。
                        </p>
                    </section>

                    <section>
                        <h2 className="text-xl font-black text-slate-900 mb-4">4. 個人情報の開示・訂正・利用停止等</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-slate-900 mb-4">5. Cookie（クッキー）等の利用について</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-slate-900 mb-4">6. プライバシーポリシーの変更</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-slate-900 mb-4">7. お問い合わせ窓口</h2>
                        <p>
