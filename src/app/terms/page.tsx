                ...
                <div className="space-y-10 text-slate-600 leading-relaxed font-medium">
                    ...
                    <section>
                        ...
                        <ol className="list-decimal pl-5 mt-2 space-y-2">
                            ...
                            <li>プラットフォームの秩序維持およびトラブル防止のため、広告主とクリエイター間の連絡・調整は、原則としてすべて当社の専属コンシェルジュ（運営）を介して行うものとします。ユーザー同士の直接連絡（SNSのDM等による直接交渉）は固く禁止します。</li>
                        </ol>
                    </section>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-slate-900 mb-4">第4条（決済と代理受領・実費精算）</h2>
                        <ol className="list-decimal pl-5 mt-2 space-y-2">
                            <li>本サービスにおける決済は、月額システム利用料（SaaS利用料）と、マッチング成立時の都度決済（クリエイターへの実費等）の「2階建て構造」とします。</li>
                            <li><strong>（都度決済と実費の定義）</strong>広告主からクリエイターに支払われる金銭は、クリエイターの交通費、機材費、および滞在経費等の「実費補填」を目的とします。</li>
                            <li><strong>（代理受領）</strong>当社は、クリエイターからの委託を受け、広告主からの実費補填金等を代理受領します。広告主が当社指定の決済リンク等より決済を完了した時点で、クリエイターに対する支払い義務は完了します。</li>
                            <li><strong>（クリエイターへの送金）</strong>当社が受領した金銭は、成果物等の納品および検収完了後、以下の通り送金されます。
                    ...
                    <section>
                        ...
                        <ol className="list-decimal pl-5 mt-2 space-y-2">
                            <li><strong>（表現手法の尊重）</strong>広告主は、クリエイターの独自の世界観および表現手法を最大限尊重するものとし、事前の絵コンテ（字コンテ）の提出や確認等は求めず、演出をクリエイターに一任するものとします。</li>
                            ...
                            <li><strong>（みなし検収）</strong>成果物等（SNS投稿の報告および動画データのアップロード）の完了後、<strong>120時間（5日間）以内</strong>に広告主から具体的な修正依頼等の異議申し立てがない場合、当該成果物等は承認（検収完了）されたものとみなします。</li>
                        </ol>
                    </section>

                    <section>
                        <h2 className="text-xl font-black text-slate-900 mb-4">第6条（成果物のデータ主導権と二次利用範囲）</h2>
                        <ol className="list-decimal pl-5 mt-2 space-y-2">
                            <li>クリエイターは、本業務の完了として、自身のSNSへの投稿を行うとともに、当社の指定するシステムへ動画データをアップロードして納品するものとします。一度納品・公開された成果物等に対するクリエイターからの事後の削除請求・非公開請求には応じません。</li>
                            <li>広告主は、納品された動画データを以下の範囲に限り利用（二次利用）できます。
                                <ul className="list-disc pl-5 mt-1 space-y-1 text-sm text-slate-500">
                                    <li>自店舗または自社のGoogle Mapsへの掲載</li>
                                    <li>自社の公式SNSアカウントおよび公式Webサイトへの「そのままの状態」での掲載</li>
                                </ul>
                            </li>
                            <li>広告主は、事前の書面による同意なく、動画データの編集（文字入れ・カット等）や、Web広告（運用型広告）への二次利用を行ってはなりません。これに違反しトラブルが生じた場合、広告主が自らの責任と費用で解決し、当社を完全に免責するものとします。</li>
                        </ol>
                    </section>
                        ...
                        <ol className="list-decimal pl-5 mt-2 space-y-2">
                            <li>当社は、プラットフォームの品質維持の観点から、広告主によるオファーの内容が以下のいずれかに該当すると判断した場合、事前の通知なく当該オファーの送信を保留、取り消し、または制限することができるものとします。
                                <ul className="list-disc pl-5 mt-1 space-y-1 text-sm text-slate-500">
                                    ...
                                    <li>報酬や提供内容が、依頼する本業務の負担に対して著しく不当であると当社が判断した場合。</li>
                    ...
                    <section>
                        <h2 className="text-xl font-black text-slate-900 mb-4">第8条（中抜き取引の禁止）</h2>
                        <ol className="list-decimal pl-5 mt-2 space-y-2">
                            <li>ユーザーは、本サービスを通じて知り得た相手方に対し、本サービスを介さずに直接取引（中抜き行為）を打診し、または契約を締結してはなりません。</li>
                    ...
                    <section>
                        ...
                        <ol className="list-decimal pl-5 mt-2 space-y-2">
                            ...
                            <li>前項にかかわらず、マッチング成立後にクリエイターの責に帰すべき事由により役務が提供されなかった場合、当社は任意の裁量によるビジネス上のサポートとして、受領済み代金（都度決済分）の全額返金、または代替クリエイターの優先手配を行うものとします。なお、広告主都合によるマッチング成立後のキャンセルおよび返金は一切お受けできません。</li>
                        </ol>
                    </section>
                    ...
                    <section>
                        ...
                        <ol className="list-decimal pl-5 mt-2 space-y-2">
                            <li><strong>（データ利用）</strong>当社システムに成果物がアップロードされた時点で、クリエイターは広告主および当社に対し、当該成果物の二次利用（Google Maps等への掲載、および当社のシステム改善・AI学習データとしての利用を含みます。）を永久的かつ無償で許諾したものとみなします。</li>
