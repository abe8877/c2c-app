        ...
        <div className="min-h-screen bg-white text-slate-900 font-sans py-20">
            <div className="max-w-3xl mx-auto px-6">
                ...
                <div className="space-y-10 text-slate-600 leading-relaxed font-medium">
                    ...
                    <section>
                        <h2 className="text-xl font-black text-slate-900 mb-4">第6条の2（権利侵害の保証と関係性の明示等）</h2>
                        <ol className="list-decimal pl-5 mt-2 space-y-2">
                            <li><strong>（権利侵害の保証）</strong>クリエイターは、成果物等が第三者の著作権、肖像権、プライバシー権、その他一切の権利を侵害していないことを保証するものとします。万が一、成果物等につき第三者から異議申し立て等があった場合、クリエイターの責任と費用においてこれを解決し、広告主および当社を完全に免責するものとします。</li>
                            <li><strong>（ステマ規制の遵守・関係性の明示）</strong>クリエイターが成果物等を自身のSNS等に投稿する際、および広告主が成果物等を自社媒体（Google Maps等）に掲載する際は、景品表示法その他の関連法令を遵守し、双方が「広告・宣伝であること（#PR、タイアップ等の明記）」を消費者に分かりやすく明示しなければならないものとします。</li>
                        </ol>
                    </section>
                    ...
                    <section>
                        ...
                        <ol className="list-decimal pl-5 mt-2 space-y-2">
                            ...
                            <li><strong>（準拠法と管轄・言語）</strong>本規約の準拠法は日本法とし、一切の紛争については東京地方裁判所を第一審の専属的合意管轄裁判所とします。また、本規約の翻訳版が作成された場合において、日本語版と翻訳版との間に齟齬が生じたときは、常に日本語版が優先して適用されるものとします。</li>
                        </ol>
                    </section>
                </div>
